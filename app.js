...
function sweethTooth(totalSweets,sweetsEaten,sweetsPenMeter,metersTravelled) {
    let remainingSweets = totalSweets - sweetsEaten - (sweetsPenMeter * metersTravelled)
    return remainingSweets > 0 ? remainingSweets / 2 : 0
}
...
function aDifficultChoice(choice) {
    switch (choice) {
        ...
        case 3:
            return  'Council her daughter herself'
        case 4:
